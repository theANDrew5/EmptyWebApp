    ...
    public class ExchangeModel : PageModel
    {
        ...
        public void OnPost(int? sum)
        {
              ...
              else
              {
                  ...
                  Message = $"При обмене {sum} рублей вы получите {result.ToString("F2")}$.";//Интерполяция строк; ToString("F2") - форматирование числа: F2 - дробное число с 2 знаками после запятой
              }
